...
export default function ProjectAtHome() {
    return (
        <div className='rounded-2xl p-6 dark:bg-gray-900 bg-gray-100'>
            ...
            <Link href='/projects'>
                <a className='group mt-6 inline-flex w-full items-center justify-center gap-2 rounded-md bg-white shadow py-2 px-3 text-sm font-medium text-gray-900 outline-offset-2 transition hover:bg-gray-50 active:bg-gray-100 active:text-gray-900/60 active:transition-none dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-gray-50 dark:active:bg-gray-800/50 dark:active:text-gray-50/70'>
                    View more
                </a>
            </Link>
        </div>
